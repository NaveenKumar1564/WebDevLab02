...
with st.form("survey_form"):
    ...
    Mon = st.text_input("How many hours do you study on Monday?")
    Tue = st.text_input("How many hours do you study on Tuesday?")
    Wed = st.text_input("How many hours do you study on Wednesday?")
    Thr = st.text_input("How many hours do you study on Thursday?")
    Fri = st.text_input("How many hours do you study on Friday?")
    Sat = st.text_input("How many hours do you study on Saturday?")
    Sun = st.text_input("How many hours do you study on Sunday?")
